...
class Contact extends Component {
    ...
    validate(firstname, lastname, telnum, email) {
        ...
        if(this.state.touched.firstname && firstname.length < 3) {
            errors.firstname = 'First name should be greater than or equals to 3';
        } else if (this.state.touched.firstname && firstname.length > 10) {
            errors.firstname = 'Last name should be less than 10';
        }

        if(this.state.touched.lastname && lastname.length < 3) {
            errors.lastname = 'First name should be greater than or equals to 3';
        ...
        if(this.state.touched.telnum && !regx.test(telnum)) {
            errors.telnum = 'Tel num should be all nums';
        } 
    ...
    render() {
        const validate = this.validate(this.state.firstname, this.state.lastname, this.state.telnum, this.state.email);
        return(
